...
<div class="row mb-5">
    ...
    <div class="col-lg">
        ...
        <input type="text" class="form-control profile-field" id="student_religion" name="religion">
    </div>
    <div class="col-lg-3">
...
<div class="row mb-5">
    <div class="col-lg">
        ...
        <input type="text" class="form-control profile-field" name="address">
    </div>
    <div class="col-lg">
        <label class="">Landline *</label>
        <input type="text" class="form-control profile-field" name="landline">
    </div>
</div>
