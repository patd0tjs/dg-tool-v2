...
@section('content')
    <h2 id="page_name" class="fw-bold">Student</h2>
      <div class="box-shadow p-5 pt-3 pb-3 bg-white rounded-4 mb-4">
        <div class="row">
          <div class="col-lg-3 text-center fw-bold align-items-center">
            <div>
              Total Students
              <br>
              <h2 class="fw-bold m-0 mb-1" id="students_enrolled">0</h2>
            </div>
          </div>
          <div class="col-lg-4"></div>
          <div class="col-lg d-flex align-items-center justify-content-center mb-1">
      ...
      <div class="table-responsive box-shadow p-4 bg-white rounded-4">
        <table id="student_tb" class="table table-striped">
            <thead>
                  <tr>
